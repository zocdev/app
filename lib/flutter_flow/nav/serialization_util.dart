  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case TeamUsersRow:
            return TeamUsersRow(data);
          case RolePermissionsRow:
            return RolePermissionsRow(data);
          case ProjectTeamsRow:
            return ProjectTeamsRow(data);
          case ClientsRow:
            return ClientsRow(data);
          case TasksRow:
            return TasksRow(data);
          case OrganizationUsersRow:
            return OrganizationUsersRow(data);
          case ProjectClientsRow:
            return ProjectClientsRow(data);
          case TimeEntriesRow:
            return TimeEntriesRow(data);
          case UserTasksRow:
            return UserTasksRow(data);
          case UserClientsRow:
            return UserClientsRow(data);
          case PermissionsRow:
          ...
          case UserProjectsRow:
            return UserProjectsRow(data);
          case UserRolesRow:
